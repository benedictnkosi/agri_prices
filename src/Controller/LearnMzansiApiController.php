...
class LearnMzansiApiController extends AbstractController
{
    ...
    /**
     * @Route("public/learn/issue/log", name="logIssue", methods={"POST"})
     */
    ...
    /**
     * @Route("public/learn/issues/active", name="getAllActiveIssues", methods={"GET"})
     */
    ...
    /**
     * @Route("public/learn/question/set-status", name="setQuestionStatus", methods={"POST"})
     */
    ...
    /**
     * @Route("public/learn/questions/captured-per-week", name="getQuestionsCapturedPerWeek", methods={"GET"})
     */
    ...
    /**
     * @Route("public/learn/questions/top-incorrect", name="getTopIncorrectQuestions", methods={"GET"})
     */
    ...
    /**
     * @Route("public/learn/questions/new-count", name="getNewQuestionsCount", methods={"GET"})
     */
